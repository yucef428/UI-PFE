...
const GeneralInformation = () => {
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      const response2 = await axios.get('http://localhost:8081/aasServer/shells/AAS_LBR_iiwa_7_R800/aas/submodels/TechnicalData/submodel/submodelElements/GeneralInformation/ManufactureOrderCode/value'); // Replace with your API URL
      const response3 = await axios.get('http://localhost:8081/aasServer/shells/AAS_LBR_iiwa_7_R800/aas/submodels/TechnicalData/submodel/submodelElements/GeneralInformation/ProductImage01/value'); // Replace with your API URL
      const response4 = await axios.get('http://localhost:8081/aasServer/shells/AAS_LBR_iiwa_7_R800/aas/submodels/TechnicalData/submodel/submodelElements/GeneralInformation/Company_logo/value'); // Replace with your API URL
      setData({
  ...
  return (
    <div className="info-container">
      ...
      <div className="data-display">
        ...
        <p><strong>Manufacter Order Code:</strong> {data.data2}</p>
